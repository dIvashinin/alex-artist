  ...
  return (
    <nav className="navigation-bar">
      <ul className="navigation-bar-nav">
        ...
        <li className="navigation-item">
          <Link to="/paintings" className="navigation-link">
            paintings
          </Link>
        </li>
        <li className="navigation-item">
          <Link to="/sculptures" className="navigation-link">
            sculptures
          </Link>
        </li>
        <li className="navigation-item">
          <Link to="/installations" className="navigation-link">
            installations
          </Link>
        </li>
        <li className="navigation-item">
          <Link to="/drawings" className="navigation-link">
            drawings
          </Link>
        </li>
        <li className="navigation-item">
